    ...
    <main id="main">
        ...
        <section id="contact" class="contact">
            ...
            <div class=" section-title">
                ...
                <p>Surat Keterangan Kelakuan Baik ( SKKB )</p>
            </div>

            <div class="col-lg-12 mt-4 mt-lg-0">
                <form method="POST" action="/permohonan-skkb" class="php-email-form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mt-3">
                        <label class="form-label">Pas photo berwarna uk.4x6</label>
