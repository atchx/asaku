...
@section('container')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Detail Permohonan </span> {{ $skkb->noreg }}</h4>
<div class="col-md-12">
    <div class="card mb-4">
        <div class="card-body">
            <form method="POST" action="/dashboard/product" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input name="nama" type="text" class="form-control" value="{{ $skkb->nama }}" required disabled />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="tempat" type="text" class="form-control" value="{{ $skkb->tempat }}" required disabled />
                </div>
                <div class="mb-3">
                    <label class="form-label">Tanggal Lahir</label>
                    <input name="tanggal" type="date" class="form-control" value="{{ $skkb->tanggal }}" required disabled />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="nomor" type="text" class="form-control" value="{{ $skkb->nomor }}" required disabled />
                </div>
                <div class="mb-3">
                    <label class="form-label">Pekerjaan</label>
                    <input name="pekerjaan" type="text" class="form-control" value="{{ $skkb->pekerjaan }}" required disabled />
                </div>
                <div class="mb-3">
                    <label class="form-label">Alamat</label>
                    <textarea name="alamat" class="form-control" rows="2" required disabled>{{ $skkb->alamat }}</textarea>
                </div>
